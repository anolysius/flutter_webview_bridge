...
class WebViewBridgeController {
  ...
  void initFlutterWebViewBridgeJavaScriptChannel(
    ...
    Future<void> Function()? onClearBadge,
    AppsFlyerAnalyticsCallback? onAppsFlyerAnalytics,
    bool appsFlyerAnalyticsEnabled = true,
    AirbridgeAnalyticsCallback? onAirbridgeAnalytics,
    ...
    _channel = FlutterWebViewBridgeJavaScriptChannel(
      ...
      onAppsFlyerAnalytics: onAppsFlyerAnalytics,
      appsFlyerAnalyticsEnabled: appsFlyerAnalyticsEnabled,
      onAirbridgeAnalytics: onAirbridgeAnalytics,
